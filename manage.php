<?php
	...
	echo '<div class="wrap">
	<h2>Last logins:</h2>
	<table cellpadding="3" cellspacing="3"><tr><th>Username</th><th>Time</th><th>IP</th><th>How Long Ago</th><th>Time Since Last Active</th></tr>';
	if ($results)
	...
	<table cellpadding="3" cellspacing="3"><tr><th>Username</th><th>Time</th><th>IP</th><th>How Long Ago</th></tr>';
	if ($results)
	foreach ($results as $result) {
